                    ...
                    <div>
                        <div class="wrap-table-shopping-cart">
                            <table class="table-shopping-cart">
                                ...
                                <tr class="table_head">
                                    <th style="font-size: 17px" class="column-1">سبد خرید شما</th>
                                </tr>

                                @foreach($products as $id => $value)
                                    <tr class="table_row">
                                        <td class="column-1">
                                            <a href="{{ route('home.cart.removeFromCart', $id) }}">
                                                <div class="how-itemcart1">
                                                    <img src="/{{ $value['thumbnail_url'] }}" alt="IMG">
                                                </div>
                                            </a>
                                        </td>
                                        <td style="font-weight: bold" class="column-2">{{ $value['title'] }}</td>
                                        <td style="font-weight: bold"
                                            class="column-3">{{ number_format($value['price']) }} تومان
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <form action="" method="post">
                            ...
                            <div class="flex-w flex-t p-t-10 p-b-33">
                                ...
                                <span class="mtext-110 cl2">
									{{ number_format($productsTotalPrice) }} تومان
								</span>
