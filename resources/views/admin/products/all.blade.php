                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.products.delete', $product->id) }}"
                                                    ...
                                                    @method('delete')
                                                    @csrf
                                                    <button class="btn btn-default btn-icons">
